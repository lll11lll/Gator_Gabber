...
        //    Your API 'sendMessage' service must be able to accept this object.
        const payload = {
            text: trimmed, 
           classContext: currentClass, 
            file: contentToSend,      // Base64 content of the file
            fileMetadata: fileMetadata // e.g., { name: "test.pdf", type: "application/pdf" }
        };

        try {
            // 4. Send the request using the JSON payload
            //    Note: This replaces FormData, so your API and 'sendMessage' service
            //    must be updated to expect a JSON object.
...
// The placeholder text dynamically changes based on whether a file is attached
